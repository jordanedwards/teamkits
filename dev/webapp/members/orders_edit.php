...
<table class="admin_table">
			<thead>
			<tr><th colspan="6">Order Items: <p style="float:right; color:#fff" class="add-item">Add items</p><i class="fa fa-plus-circle fa-lg add-icon add-item no_print"></i></th></tr>
