...
if (!$page_id > 0){
	...
	<?php if ($currentUser->get_role() ==1){?>
		...
		<tbody>
			<tr>
				<td>View</td><td><input type="checkbox" name="superuser[view]" value="1" checked="checked"/></td><td><input type="checkbox" name="admin[view]" value="1"/></td><td><input type="checkbox" name="user[view]" value="1"/></td>
			</tr>
			<tr>
				<td>Edit</td><td><input type="checkbox" name="superuser[edit]" value="1" checked="checked"/></td><td><input type="checkbox" name="admin[edit]" value="1" /></td><td><input type="checkbox" name="user[edit]" value="1" /></td>
			</tr>	
			<tr>
