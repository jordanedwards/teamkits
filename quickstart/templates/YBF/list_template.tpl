...
echo '<td align="center" style="width:50px"><a href="/' . $this->actions_url . '/action_' . $this->selected_table . '_edit.php?action=delete&id={' . $this->index_name . '}" onclick="return confirm(\'You are about to delete a ' . $this->selected_table . ' from the system. Do you want to continue?\');"><i class="fa fa-times-circle fa-lg"></i></a></td>';
?></tr>
</table><br />