...
echo '<td align="center"><a href="/' . $this->actions_url . '/action_' . $this->selected_table . '_edit.php?action=delete&id={' . $this->index_name . '}" onclick="return confirm(\'You are about to delete a ' . $this->selected_table . ' from the system. Do you want to continue?\');"><img src="/invoices/images/delete.gif" alt="Delete" border="0" /></a></td>';
?></tr>
</table><br />