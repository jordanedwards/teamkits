...
<body>
	<div id="page_wrapper">
    <dynamic> include($INCLUDES . "/admin_header.php"); </dynamic>
    <div id="right_column">
    	<div id="content_wrapper">
        <dynamic> include($INCLUDES . "/system_messaging.php"); </dynamic>
        <h1><img src="/images/icon_maintenance.png" /><dynamic>if ($_GET["id"] ==0){</dynamic> Add <?php echo ucfirst($this->selected_table) ?><dynamic> } else {</dynamic> Edit <?php echo ucfirst($this->selected_table) ?><dynamic> }</dynamic></h1>
...
?>
    ...
    <dynamic> include($INCLUDES . "/left_admin_column.php"); ?>
  </div>
  <dynamic> include($INCLUDES . "/admin_footer.php"); ?>
</body>
</html>