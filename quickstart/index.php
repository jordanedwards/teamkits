...
// If you add a field to the form, all you need to do is add another entry here and it will save and load properly
   function loadProject(projectName) {
          ...
          $.getJSON('projects/'+projectName, function(jd) {
			 ...
			 $('#website_email').val(jd.website_email);		  
			 $('#mail_server').val(jd.mail_server);		  
			 $('#mail_username').val(jd.mail_username);		  
			 $('#mail_password').val(jd.mail_password);		  
			 $('#mail_port').val(jd.mail_port);		  
			 ...
			 $('#scripts_url').val(jd.scripts_url);
			 $('#css_url').val(jd.css_url);
...
<!-- Configuration Page -->
          <section class="idealsteps-step" name="Settings">
            ...
            <div class="field">
              <label class="main">Technical Support Email:</label>
...
<div class="accordion">
			...
			<h3>Website Email Address:</h3>
              <div>
				<label style="line-height:1"><input name="website_email" id="website_email" type="text" value="<?php if($_GET['load_project']==0){echo "website@";}?>"></label>			
            </div>
						
           <h3>Mail Server:</h3>
              <div>
				<label style="line-height:1"><input name="mail_server" id="mail_server" type="text" value="<?php if($_GET['load_project']==0){echo "mail.";}?>"></label>			
            </div>
   
            <h3>Username:</h3>
              <div>
				<label style="line-height:1"><input name="mail_username" id="mail_username" type="text" value="<?php if($_GET['load_project']==0){echo "website@";}?>"></label>			
            </div>

            <h3>Password:</h3>
              <div>
				<label style="line-height:1"><input name="mail_password" id="mail_password" type="password" value=""></label>			
            </div>

            <h3>Port:</h3>
              <div>
				<label style="line-height:1"><input name="mail_port" id="mail_port" type="text" value="<?php if($_GET['load_project']==0){echo "465";}?>"></label>			
            </div>
...
<div class="accordion">
			...
			<h3>Base Folder:</h3>
              <div>
				<label style="line-height:1"><i>/</i><input name="base_url" id="base_url" type="text" value=""></label>			
            </div>
           ...
           <h3>CSS Folder:</h3>
              <div>
				<label style="line-height:1"><i>Base Folder/</i><input name="css_url" id="css_url" type="text" value="<?php if($_GET['load_project']==0){echo "css";}?>"></label>			
            </div>

           <h3>Scripts Folder:</h3>
              <div>
				<label style="line-height:1"><i>Base Folder/</i><input name="scripts_url" id="scripts_url" type="text" value="<?php if($_GET['load_project']==0){echo "scripts";}?>"></label>			
            </div>
...
<!-- Options page -->
	<section class="idealsteps-step" name="Options">
		<div class="field">
		  <label class="main">Modules:</label>
		  <p class="group">
			<label><input name="options[acl]" id="options_acl" type="checkbox" value="1" checked>ACL Module</label>
			<label><input name="options[url_rewriting]" id="options_url_rewriting" type="checkbox" value="1" >URL Rewriting</label>
			<label><input name="options[cms]" id="options_cms" type="checkbox" value="1" >Content Management System</label>
			<label><input name="options[google_analytics]" id="options_google_analytics" type="checkbox" value="1" >Google Analytics</label>							
		  </p>
		  <span class="error"></span>
		</div>	
		<br>
		<div class="field">
		  <label class="main">Libraries:</label>
		  <p class="group">
			<label><input name="libraries[jquery]" id="libraries_jquery" type="checkbox" value="1" checked>jQuery</label>
			<label><input name="libraries[jqueryui]" id="libraries_jqueryui" type="checkbox" value="1" >jQueryUI</label>
			<label><input name="libraries[select2]" id="libraries_select2" type="checkbox" value="1" ><a href="https://select2.github.io/">Select2</a></label>
			<label><input name="libraries[tiltshift.js]" id="libraries_tiltshift" type="checkbox" value="1" ><a href="http://www.noeltock.com/tilt-shift-css3-jquery-plugin/">TiltShift.js</a></label>	
			<label><input name="libraries[jquery.mask.js]" id="libraries_jquery_mask" type="checkbox" value="1" ><a href="http://igorescobar.github.io/jQuery-Mask-Plugin/">jQuery Mask</a></label>				
		  </p>
		  <span class="error"></span>
		</div>	  
		<br>
		<div class="field">
		  <label class="main">Web Fonts:</label>
		  <p class="group">
			<label><input name="fonts[opensans]" id="fonts_opensans" type="checkbox" value="1" checked>Open Sans</label>
			<label><input name="fonts[roboto]" id="fonts_roboto" type="checkbox" value="1" >Roboto</label>
			<label><input name="fonts[lato]" id="fonts_lato" type="checkbox" value="1" >Lato</label>
			<label><input name="fonts[ubuntu]" id="fonts_ubuntu" type="checkbox" value="1" >Ubuntu</label>
			<label><input name="fonts[montserrat]" id="fonts_montserrat" type="checkbox" value="1">Montserrat</label>
			<label><input name="fonts[pacifico]" id="fonts_pacifico" type="checkbox" value="1" >Pacifico</label>													
		  </p>
		  <span class="error"></span>
		</div>
	</section>
...
<script>
  ...
  /*    rules: {
	...
	steps: {
  MY_stepsItems: ['Configuration', 'Modules & Libraries', 'SQL Generator/Designer', 'Class, Action, View files', 'Utilites'],
