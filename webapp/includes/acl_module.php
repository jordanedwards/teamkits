...
<?php if ($currentUser->get_role() ==1){?>
	...
	//echo "permission: " . $line['permission'];
		...
		if (!$access){
			echo "You do not have access to this resource.<br>Permission level: " . $currentUser->get_role() . "<br>Page id: " .$page_id . "<br>Action: " . $_REQUEST['action'] . "<br><br><a href='/login.php'>&raquo; Homepage</a>";
			exit;
		} 
	}
