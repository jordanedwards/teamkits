...
<html lang="en">
  <head>
    ...
    <title><?php  echo $appConfig["app_title"];  ?> | Promo List</title>
  </head>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <i class="fa fa-plus-circle"></i> <a href="promo_edit.php?id=0">Add New Promo</a></p>
<?php 
...
$dm = new DataManager();
			...
			$s_title = escaped_var_from_post("s_title");
			$s_view_list = escaped_var_from_post("s_view_list");
			$s_wholesale = escaped_var_from_post("s_wholesale");
        ...
        <div id="search">
          <form action="<?php  echo $_SERVER["PHP_SELF"]  ?>?reload=true" method="post" name="frmFilter" id="frmFilter">
            <table class="admin_table" style="display:block">
              <tr>
			  <td>Promo Id</td><td>Promo Sport</td><td>Promo Title</td><td>Promo View_list</td><td>Promo Wholesale</td><td>Promo Price</td><td>Promo Active</td>				<td><input type="button" class="clear" value="Clear" /></td>
              </tr>
			  
              <tr>
			  <td><input type="text" name="s_id"  value="<?php  echo $s_id  ?>"/></td>
				<td><input type="text" name="s_sport"  value="<?php  echo $s_sport  ?>"/></td>
				<td><input type="text" name="s_title"  value="<?php  echo $s_title  ?>"/></td>
				<td><input type="text" name="s_view_list"  value="<?php  echo $s_view_list  ?>"/></td>
