...
$activeMenuItem = "Orders";
	...
	$session->setAlertMessage("Club members may pay for their own items on this order individually. If complete payment is made before the deadline, we'll submit the order right away.");
...
<div id="accordion">			
		 <?php 
			...
			ORDER BY name ASC, item.item_name ASC
			";						
					...
					// Don't show shipping charge
						...
						if (!isset($rowname)){
							...
							echo '
								...
								<input type="button" class="btn btn-default pull-right" style="margin:10px;" value="Go to Cart" onClick="window.location =\'cart.php\'" />
							  </div>
							  </div>
